...
// ═══════════════════════════════════════════════════════════════
// GROUP STAGE + KNOCKOUT (merged from groups.js)
// ═══════════════════════════════════════════════════════════════
...
window._generateGroupKnockout = async () => {
  ...
  for (let i = 0; i < bracketSize / 2; i++) {
    ...
    matches.push({
      ...
      homeName: home ? home.name : 'BYE',
      awayId: away ? away.id : null,
      awayName: away ? away.name : 'BYE',
