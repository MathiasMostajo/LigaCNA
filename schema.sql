-- ═══════════════════════════════════════════════════════════════
-- PASO 1: Borrar todo y empezar limpio
-- ═══════════════════════════════════════════════════════════════
...
DROP FUNCTION IF EXISTS public.generate_league_slug() CASCADE;
...
-- ═══════════════════════════════════════════════════════════════
-- PASO 5: Crear profiles para usuarios que ya existen
-- ═══════════════════════════════════════════════════════════════
INSERT INTO public.profiles (id, email, display_name)
...
-- ═══════════════════════════════════════════════════════════════
-- PASO 6: Activar superadmin (CAMBIA EL EMAIL)
-- ═══════════════════════════════════════════════════════════════
UPDATE public.profiles SET role = 'superadmin', plan_type = 'superadmin' WHERE email = 'mathiasx101@gmail.com';
